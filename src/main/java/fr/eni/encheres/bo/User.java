...
public class User {
  ...
  public User(String pseudo, String name, String first_name, String mail, String phone_number,
      String address, String zip_code, String city, String password, int credit,
  ...
  public String toString() {
    return "User [no_user=" + no_user + ", pseudo=" + pseudo + ", name=" + name + ", first_name="
        + first_name + ", mail=" + mail + ", phone_number=" + phone_number + ", address=" + address
        + ", zip_code=" + zip_code + ", city=" + city + ", password=" + password + ", credit="
        + credit + ", isAdministrator=" + isAdministrator + "]";
  }
}
