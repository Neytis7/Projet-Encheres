...
public class Utils {
	...
	final public static ArrayList<String> uniqueLogin(UserDaoImpl userDAO, User user) throws DALException {
		...
		try {
			...
			throw new DALException(new Exception("Une erreur est survenue pour la récupération de la liste des login"));
		}
