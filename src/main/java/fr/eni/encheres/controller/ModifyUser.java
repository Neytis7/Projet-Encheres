...
public class ModifyUser extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String btnValidateModification = (String) request.getParameter("btnValidateModification");
		...
		if(session != null && session.getAttribute("idUserConnected") != null) {
			...
			if(btnValidateModification != null) {
				User userToModify = new User(idUserConnected,
											...
											request.getParameter("phoneNumberUser"),
											request.getParameter("addressUser"),
											request.getParameter("zipCodeUser"),
											request.getParameter("cityUser"),
											request.getParameter("passwordUser"),
											Integer.parseInt(request.getParameter("credit")),
											false);
				errors = userToModify.checkInformations();
				if (!request.getParameter("passwordUser").trim().equals(request.getParameter("confirmPasswordUser").trim())) {
					errors.add("Les mots de passe rentrés ne correspondent pas.");
			...
			errors.add("Vous devez vous connecter pour accèder à votre profil");
			redirectServlet =  "WEB-INF/Home.jsp";
		}
