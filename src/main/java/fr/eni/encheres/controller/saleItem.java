 ...
 */
@WebServlet(description = "Permet à l'utilisateur de vendre un article", urlPatterns = { "/sale-item" })
public class saleItem extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String btnSubmitItem = (String) request.getParameter("btnSubmitItem");
		ArrayList<String> errors = new ArrayList<>();
		...
		if(session != null && session.getAttribute("idUserConnected") != null) {
			...
			if(btnSubmitItem != null) {
				...
				String descriptionItem = (String) request.getParameter("descriptionItem");
				String adressItemUser = (String) request.getParameter("adressItemUser");
				String zipCodeItemUser = (String) request.getParameter("zipCodeItemUser");
				String cityItemUser = (String) request.getParameter("cityItemUser");

				article = new Article(nameItem, descriptionItem, startDateItem, endDateItem, priceItem, 0, userConnected, false );
				errors = article.checkValueArticle(false);
	
				try {
					categoyItem = Integer.parseInt((String) request.getParameter("categoyItem"));
				...
				try {
					...
					if(category != null) {		
						...
						idArticle = articleManager.creerArticle(article);
	...
	public void redirection(String path, ArrayList<String> paramError, String paramSuccess, HttpServletRequest request, 
			HttpServletResponse response, boolean exitSession) throws ServletException, IOException {
